...
class Client(object):
    ...
    def run(self):
        ...
        Runs the game
        """
        print "Starting Battle Tetris Client..."
        ...
        self.game_info.client_token = self.comm.send(connect_command, command.Command.CLIENT_TOKEN)
        ...
        #
        #
        self.algorithm = algorithm.Algorithm(self.game_info.client_token, self.cmd, self.comm)
        self.algorithm.run()
        #
